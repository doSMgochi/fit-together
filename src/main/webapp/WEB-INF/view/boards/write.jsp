...
<body>
	...
	<div class="wrap-l px-1">
		<div
			...
			<form
				action="${pageContext.servletContext.contextPath }/boards/write-handle"
				method="post">
				<table style="border-collapse: collapse; width: 100%">
					<tr>
						<td
							style="border: 1px solid #ccc; padding: 12px; text-align: center; background-color: #eee; width: 120px">작성자</td>
						<td style="border: 1px solid #ccc; padding: 12px;">${writerId }</td>
					</tr>
					<tr>
						<td
					...
					<tr>
						<td style="border: 1px solid #ccc; padding: 12px;" colspan="2">
							<textarea name="body"
								style="height: 300px; resize: none; width: 100%; box-sizing: border-box; padding: 6px 10px; border: 1px solid #ccc"></textarea>
